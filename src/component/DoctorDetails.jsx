...
const DoctorDetails = ({ doctorData }) => {
     ...
     return (
        <div className='py-10 mt-10'>
            <Card className='mx-auto w-250 hover:shadow-lg hover:transition hover:shadow-cyan-300 py-15'>
                ...
                <BookingModal className='mt-6 justify-end bg-cyan-500 duration-300 hover:transition hover:bg-cyan-900 text-white' />
