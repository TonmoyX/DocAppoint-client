    ...
    return (
        <div className=' space-x-2 md:flex md:gap-25 mt-10 items-center mx-auto justify-center md:px-20'>
            <div className='mx-5'>
                ...
                <h1 className=' text-4xl md:text-4xl mt-4 text-cyan-600 font-bold'>Best Medical Clinic For
            ...
            <div>
                <Image className='mx-auto w-80 h-80 mt-10 md:w-120 md:h-80 lg:w-150 lg:h-150 rounded-2xl hover:scale-105 transition duration-300' src={banner} alt={'bannerImage'} width={1000} height={1000}></Image>
            </div>
        </div>
    );
};
